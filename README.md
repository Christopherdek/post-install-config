...
The first step to take is to make a new role called Supreme Admin. To create a new role, open the Admin panel enter the Agents Menu. Click on Roles and create the new role from there.
</p>
<br />
...
<p>
New users will be created so they can create tickets so that the agents can receive and allocate them. To create new users, enter the Agents panel and open the Users menu. Click on Add User and create the account credentials necessary for each new user. In this case, Karen and Ken have been created.
</p>
<br />
...
Now that the configurations have been set in place, I can now utilize osTicket as a proper ticketing system. I can create tickets and be able to allocate them as if I were in a real environment.
